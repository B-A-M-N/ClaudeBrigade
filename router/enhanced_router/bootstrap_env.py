...
ALLOWED_PROVIDER_KEYS = frozenset({
    ...
    # Names emitted by the standalone FreeInference/LiteLLM kit.  Keep these
    # as compatibility aliases so an existing providers.env never prevents
    # the configuration CLI or router from starting.
    "FREEINFERENCE_OPENAI_BASE",
    "FREEINFERENCE_ANTHROPIC_BASE",
    "FREEINFERENCE_OPENAI_API_BASE",
    "FREEINFERENCE_ANTHROPIC_API_BASE",
